...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setStatusMessage("[ ESTABLISHING SECURE UPLINK... ]");
  ...
  const handleGoogleSignIn = () => {
    ...
    setTimeout(() => {
      setIsSubmitting(false);
      setStatusMessage("[ GOOGLE PROFILE RESOLVED. REDIRECTING... ]");
      setTimeout(() => {
        window.location.href = "/";
      }, 1000);
    }, 1500);
    ...
    <div style={containerStyle}>
      ...
      <header className="header">
        ...
        <div className="header-right">
          ...
          <span style={dividerPipeStyle}>|</span>
          <Link href="/login" className="nav-link" style={{ display: "inline-flex", alignItems: "center", color: "var(--success)" }}>
            <span>[</span>
      ...
      <div className="animate-slide-fade" style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center", alignItems: "center", paddingTop: "var(--space-2xl)", paddingBottom: "var(--space-2xl)" }}>
        <div style={cardStyle} className="dot-grid-subtle">
          <div style={cardHeaderStyle}>
            <span style={labelMonoStyle}>SECURE ACCESS PORTAL</span>
            <span style={badgeStyle}>AUTHENTICATE</span>
          </div>

          <h2 style={titleStyle}>
            <MatrixText text="LOGIN" />
          </h2>
          <p style={subStyle}>DECRYPT USER ARCHIVE</p>
          ...
          <form onSubmit={handleSubmit} style={formStyle} noValidate>
            ...
            {statusMessage && (
              <div style={{
                ...statusMessageStyle,
                color: statusMessage.includes("GRANTED") || statusMessage.includes("RESOLVED") ? "var(--success)" : statusMessage.includes("FAILED") ? "var(--accent)" : "var(--text-primary)"
              }}>
                {statusMessage}
              </div>
            )}
            ...
            <button
              ...
              disabled={isSubmitting}
            >
              {isSubmitting ? "[ UPLINK ACTIVE ]" : "SUBMIT CREDENTIALS"}
            </button>
          </form>
          ...
          <div style={footerLinkContainerStyle}>
            <span style={footerLinkTextStyle}>NEW SYSTEM OPERATOR?</span>
