...
import LandingInteractiveSandbox from "./components/LandingInteractiveSandbox";
import LandingTaxCalculator from "./components/LandingTaxCalculator";
import LandingComparisonMatrix from "./components/LandingComparisonMatrix";
...
export default function Home() {
  ...
  return (
    <div className="pixel-bg-pattern" style={{ minHeight: "100vh", width: "100%", position: "relative" }}>
      ...
      {/* Live OCR Demo Interactive Sandbox */}
      ...
      <footer style={footerSpecsSectionStyle}>
        ...
        <div style={bottomCopyrightStyle}>
          <div style={{ display: "flex", gap: "12px", alignItems: "center", marginBottom: "8px" }}>
            ...
            <span style={dividerPipeStyle}>|</span>
            <Link href="/release-notes" className="nav-link" style={{ display: "inline-flex", alignItems: "center" }}>
              <span>[</span>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, margin: "0 4px" }}>
