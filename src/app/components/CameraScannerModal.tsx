        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            >
              ...
              <option value="standard">⟐ AUTO (GROQ → GEMINI → OLLAMA → PADDLE → TESS)</option>
            </select>
          </div>
          ...
          >
            ...
            <span>{isCapturing ? "[ CAPTURING... ]" : `[ CAPTURE & ${selectedEngine === "groq" ? "GROQ AI" : selectedEngine === "gemini" ? "GEMINI AI" : selectedEngine === "paddle" ? "PADDLE OCR" : selectedEngine === "llama32" ? "LLAMA 3.2" : selectedEngine === "ollama" ? "OLLAMA AI" : selectedEngine === "tesseract" ? "TESS+AI" : "AUTO"} SCAN ]`}</span>
          </button>
        </div>
      </div>
    </div>
